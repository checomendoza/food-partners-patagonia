	...
	return (
		item && (
			<div className="w-full justify-center relative">
				...
				<container className="w-full lg:flex lg:flex-col lg:mx-60 lg:w-8/12">
					...
					<div className="mt-5">
						<h1 className="text-xl text-center text-gray-700 font-bold py-1 border-t border-gray-300">Acciones</h1>
						{novedades &&
					...
					{derivar && (
						<div className="text-center mt-10" id="div_derivar">
							<form onSubmit={handleSubmit}>
								<p className="text-gray-600 text-xs mx-5 pt-10">
